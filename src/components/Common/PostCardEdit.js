...
import { createTrade, updateDBUser, editPost } from '../../actions';
...
class PostCardEdit extends Component {
    ...
    render = () => {
        ...
        return (
            <form onSubmit={this.onSubmit} encType="multipart/form-data" className="editPost">
...
export default compose(
  	withAuthorization(),
	connect(mapStateToProps, { createTrade, updateDBUser, editPost })
)(PostCardEdit);